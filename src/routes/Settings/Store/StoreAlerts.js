...
class Alerts extends Component {
          ...
          if (data.length > 0) {
            for (let i = 0; i < data.length; i++) {
              ...
              if (data[i].isWhatsAppCustomer) {
                ...
                var placeTemp = [];
                data[i].whatsAppSelectedVariables.split(",").forEach((element) => {
    ...
    if (this.state.alertEdit.selectedAlertType) {
      ...
      setTimeout(() => {
        if (
          ...
          this.state.WhatsappCustomerContentCompulsion === "" &&
          this.state.WhatsappInternalContentCompulsion === ""
        ) {
          this.setState({
  ...
  setWhatsappPlaceholderValueText = (name, e) => {
    var finalval = this.state.placeholderData.filter(
      (x) => x.mailParameterID == Number(e.target.value)
    )[0].parameterName;

    if (name === "customer") {
      var notiContent = this.state.selectedWhatsappCustomerContent;
      notiContent += " " + finalval;
      this.setState({ selectedWhatsappCustomerContent: notiContent });
    } else {
      var notiContent = this.state.selectedWhatsappInternalContent;
      notiContent += " " + finalval;
      this.setState({ selectedWhatsappInternalContent: notiContent });
    }
  };
  setEditWhatappPlaceholderValueText = (name, e) => {
    var finalval = this.state.placeholderData.filter(
      (x) => x.mailParameterID == Number(e.target.value)
    )[0].parameterName;
    if (name === "customer") {
                ...
                <div className="right-sect-div">
                  ...
                  <div className="div-cntr">
                    ...
                    <Checkbox
                      ...
                      value="whatsappCust"
                      onChange={this.handleAlertTabs.bind(this, "1")}
                      checked={this.state.viewWhatsappCustomer}
                    >
                      {TranslationContext !== undefined
                        ? TranslationContext.checkbox.customer
                        : "Customer"}
                    ...
                    <Checkbox
                      ...
                      value="whatsappInt"
                      onChange={this.handleAlertTabs.bind(this, "1")}
                      checked={this.state.viewWhatsappInternal}
                    >
                      {TranslationContext !== undefined
                        ? TranslationContext.checkbox.internal
                        : "Internal"}
                                  ...
                                  <li className="nav-item">
                                    <a
                                      className={`nav-link ${this.state
                                        ...
                                        "active"}`}
                                      data-toggle="tab"
                                      href="#Customer-whatsapp-tab"
                                      role="tab"
                                      aria-controls="Customer-whatsapp-tab"
                                      aria-selected="false"
                                    >
                                      Customer
                                    </a>
                                  ...
                                  <li className="nav-item">
                                    <a
                                      className={`nav-link ${this.state
                                        ...
                                        "active"}`}
                                      data-toggle="tab"
                                      href="#Internal-whatsapp-tab"
                                      role="tab"
                                      aria-controls="Internal-whatsapp-tab"
                                      aria-selected="false"
                                    >
                                      Internal
                                    </a>
                            ...
                            <div className="tab-content p-0 alert-p1">
                              <div
                                className={`tab-pane fade ${this.state
                                  .innerTabIndexWhatsapp === 0 &&
                                  "show active"}`}
                                id="Customer-whatsapp-tab"
                                role="tabpanel"
                                aria-labelledby="Customer-whatsapp-tab"
                              >
                                <div className="sms-mainLabel alert-p1">
                                  <div>
                                    <label className="alert-main-popuplbl">
                                      Compose your Whatsapp Content
                                    </label>
                                  </div>
                                  <div className="row">
                                    <div className="col-6 col-md-6">
                                      <Select
                                        ...
                                        options={
                                          this.state.whatsappTamplateList
                                        }
                              ...
                              <div
                                className={`tab-pane fade ${this.state
                                  .innerTabIndexWhatsapp === 1 &&
                                  "show active"}`}
                                id="Internal-whatsapp-tab"
                                role="tabpanel"
                                aria-labelledby="Internal-whatsapp-tab"
                              >
                                <div className="sms-mainLabel alert-p1">
                                  <div>
                                    <label className="alert-main-popuplbl">
