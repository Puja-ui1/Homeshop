...
class ShoppingBagTab extends Component {
  ...
  handleCheckOrderItemData(itemId) {
    if (this.state.ShopItemData.length > 0) {
      ...
      if (ordItem.length === 0) {
        ...
        document.getElementById("ord" + itemId + "Itm").style.display = "block";
        dragElement(document.getElementById("ord" + itemId + "Itm"));
      }
    } else {
      this.handleOrdItemOpen(itemId);
    }
    ...
    axios({
      ...
      .then(function(res) {
        ...
        if (status === "Success" && data.length > 0) {
          ...
          document.getElementById("ord" + itemId + "Itm").style.display =
            "block";
          dragElement(document.getElementById("ord" + itemId + "Itm"));
        } else {
          // self.setState({
  ...
  handleCloseItemPop(itemId) {
    document.getElementById("ord" + itemId + "Itm").style.display = "none";
    this.setState({
      popUpClicking: false,
    });
  }
    ...
    return (
      <>
        ...
        <div className="table-cntr store dv-table-paging shopbag">
          <p className="shopi">Shopping Bag</p>
